...
private int id;
	...
	public void populateByCarWash(CarWash carWash) {
		setId(carWash.getId());
		setDateBeginWash(carWash.getDateBeginWash());
		setDateEndWash(carWash.getDateEndWash());
		setCarWashType(carWash.getCarWashType());
	}
}
