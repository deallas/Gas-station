...
<form:form method="POST" modelAttribute="carWashEditForm" class="form-horizontal" id="form-add">
	...
	<div id="form-add-data">
		...
		<div class="control-group<spring:bind path="dateEndWash"><c:if test="${status.error}"> error</c:if></spring:bind>">
			<label class="control-label required" for="dateEndWash"><spring:message code="label.carwash.datebeginwash" />:</label>
			<div class="controls">
