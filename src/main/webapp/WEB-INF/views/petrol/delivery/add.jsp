...
<form:form method="POST" modelAttribute="petrolDeliveryAddForm" class="form-horizontal" id="form-add">
	...
	<div class="well form-title">
		...
		<h3><spring:message code="title.petrol.delivery.add" /></h3>
	</div>
		...
		<div class="control-group<spring:bind path="deliveryDate"><c:if test="${status.error}"> error</c:if></spring:bind>">
			...
			<div class="controls">
  			<div id="datetimepicker" class="input-append">
    			<input data-format="dd-MM-yyyy" type="text" name="deliveryDate" />
    			<span class="add-on">
		...
		<div class="control-group<spring:bind path="orderDate"><c:if test="${status.error}"> error</c:if></spring:bind>">
			...
			<div class="controls">
  			<div id="datetimepicker2" class="input-append">
    			<input data-format="dd-MM-yyyy" type="text" name="orderDate" />
    			<span class="add-on">
      				<i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
    			</span>
  			</div>
