...
<form:form method="POST" modelAttribute="petrolProviderAddForm" class="form-horizontal" id="form-add">
	...
	<div class="well form-title">
		...
		<h3><spring:message code="title.petrol.provider.add" /></h3>
	</div>
	<div id="form-add-data">
		<div class="control-group<spring:bind path="companyName"><c:if test="${status.error}"> error</c:if></spring:bind>">
			<label class="control-label required" for="name"><spring:message code="label.petrol.provider.companyname" />:</label>
			<div class="controls">
