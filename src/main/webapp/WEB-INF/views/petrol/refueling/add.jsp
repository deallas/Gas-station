...
<form:form method="POST" modelAttribute="refuelingAddForm" class="form-horizontal" id="form-add">
	...
	<div class="well form-title">
		...
		<h3><spring:message code="title.petrol.refueling.add" /></h3>
	</div>
		...
		<div class="control-group<spring:bind path="refuelingDate"><c:if test="${status.error}"> error</c:if></spring:bind>">
			...
			<div class="controls">
  			<div id="datetimepicker" class="input-append">
    			<input data-format="dd-MM-yyyy" type="text" name="refuelingDate" />
    			<span class="add-on">
